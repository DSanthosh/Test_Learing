    ...
    class TestUtlity
    {
        ...
        public void NewProfile(IWebDriver driver, ExtentTest test, ExtentReports extent)
        {
            try
            {
                ...
                driver.FindElement(By.XPath("//*[@class='col-sm-12 col-md-12 col-lg-12 signup-talent1-form-main' and not(@id)]//input[@id='talusername']")).SendKeys(ConfigurationManager.AppSettings["userName"]);
        ...
        public void UpdateProfile(IWebDriver driver, ExtentTest test, ExtentReports extent)
        {
            ...
            Thread.Sleep(1000);
            driver.FindElement(By.XPath("//input[contains(@id, 'username') and  contains(@class, 'login-modal-usertext')]")).SendKeys(ConfigurationManager.AppSettings["userName"]);
            ...
            driver.FindElement(By.XPath("//input[@id='telephone']")).SendKeys("426854188");
            ...
            test.Log(Status.Pass, "Successfully Update the profile");
            }
            catch (Exception e)
            {
